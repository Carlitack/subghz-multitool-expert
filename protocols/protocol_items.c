...
static const ProtoPirateProtocolCatalogEntry protopirate_protocol_catalog[] = {
    ...
    {"Security+ 2.0", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Somfy Keytis", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Somfy Telis", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Hormann Bisecur", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Chamberlain Code", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    ...
    {"Came Twee", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Nice Flo", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Nice Flor-S", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"FAAC SLH", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Hormann", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"Gate TX", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
    {"KingGates Stylo", ProtoPirateProtocolCatalogRouteAMDefault, NULL},
